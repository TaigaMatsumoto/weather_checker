...
class Page extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      api:
        'http://api.openweathermap.org/data/2.5/weather?q=&&appid=36b79456f480f88aeadc9d2299141bcb',
    };
    ...
    this.setState(
      {
        ...
        }&&appid=36b79456f480f88aeadc9d2299141bcb`,
      },
      () => {
        fetch(this.state.api).then((response) => {
          if (response.ok) {
            return response
              .json()
              .then((myJson) => {
      ...
      <div>
        ...
        <div className="button">
          ...
          <Row className="city-name-form">
            <Input
              label="type city name here"
              value={this.state.input.city}
              onChange={this.handleChange}
            />
          </Row>
          <Button waves="light" onClick={this.getLocationName} type="button">
            Search!
            <Icon left>
cloud
            </Icon>
